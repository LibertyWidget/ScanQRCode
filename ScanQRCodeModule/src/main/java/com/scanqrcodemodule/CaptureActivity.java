...
import com.scanqrcodemodule.zbar.camera.CameraManager;
import com.scanqrcodemodule.zbar.decode.MainHandler;
import com.scanqrcodemodule.zbar.utils.BeepManager;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onResume() {
        super.onResume();
        if (isOpenCamera) {
            SurfaceHolder mHolder = scanPreview.getHolder();
    ...
    private int checkPermission() {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            try {
                ...
                Object[] args = new Object[]{26, Binder.getCallingUid(), getPackageName()};
